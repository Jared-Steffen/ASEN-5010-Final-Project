function plot_attitude_sim(t,X,Xr,Xe,u,switch_idx,switch_modes,constants)
    ...
    subplot(4,1,1)
    plot(t, mrpBN(1,:), 'LineWidth', 1.5)
    hold on
    plot(t, mrpRN(1,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ylabel('\sigma_{1}')
    ...
    subplot(4,1,2)
    plot(t, mrpBN(2,:), 'LineWidth', 1.5)
    hold on
    plot(t, mrpRN(2,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(4,1,3)
    plot(t, mrpBN(3,:), 'LineWidth', 1.5)
    hold on
    plot(t, mrpRN(3,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(4,1,4)
    plot(t, vecnorm(mrpBN,2,1), 'LineWidth', 1.5)
    hold on
    plot(t, vecnorm(mrpRN,2,1),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(3,1,1)
    plot(t, BwBN(1,:), 'LineWidth', 1.5)
    hold on
    plot(t, BwRN(1,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(3,1,2)
    plot(t, BwBN(2,:), 'LineWidth', 1.5)
    hold on
    plot(t, BwRN(2,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(3,1,3)
    plot(t, BwBN(3,:), 'LineWidth', 1.5)
    hold on
    plot(t, BwRN(3,:),'--', 'LineWidth', 1)
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
    end
    ...
    subplot(2,1,1)
    plot(t, vecnorm(BH,2,1), 'LineWidth', 1.5)
    hold on
    for i = 1:length(switch_idx)
    xline(t(switch_idx(i)), ':w', switch_modes{i}, ...
        'LineWidth', 1.5, 'LabelOrientation', 'horizontal','FontSize', 14);
